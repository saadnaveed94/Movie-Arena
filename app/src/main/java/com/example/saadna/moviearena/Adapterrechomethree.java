...
public class Adapterrechomethree extends RecyclerView.Adapter<Adapterrechomethree.MyViewHolder>{
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            imageButton = (ImageButton)view.findViewById(R.id.imghomerecthree);
            t1 = (TextView)view.findViewById(R.id.txthomerecthree);
    ...
    public Adapterrechomethree(List<String> url, List<String> txt1,List<String> vid) {
...
this.vid= vid;
    ...
    @Override
    public Adapterrechomethree.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.cardforrechomethree, parent, false);
        return new Adapterrechomethree.MyViewHolder(itemView);

    }


    @Override
    public void onBindViewHolder(Adapterrechomethree.MyViewHolder holder, final int position) {
