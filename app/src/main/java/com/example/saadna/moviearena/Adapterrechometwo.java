...
public class Adapterrechometwo extends RecyclerView.Adapter<Adapterrechometwo.MyViewHolder>{
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            imageButton = (ImageButton)view.findViewById(R.id.imghometwo);
            t1 = (TextView)view.findViewById(R.id.txthometwo);
    ...
    public Adapterrechometwo(List<String> url, List<String> txt1,List<String> vid) {
    ...
    @Override
    public Adapterrechometwo.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.cardforrechometwo, parent, false);
        return new Adapterrechometwo.MyViewHolder(itemView);

    }


    @Override
    public void onBindViewHolder(Adapterrechometwo.MyViewHolder holder, final int position) {
