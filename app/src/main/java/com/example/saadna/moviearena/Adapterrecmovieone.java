...
public class Adapterrecmovieone extends RecyclerView.Adapter<Adapterrecmovieone.MyViewHolder>{
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            t2= (TextView)view.findViewById(R.id.textmovieonetwo);
        }
    }
    public Adapterrecmovieone(List<String> url, List<String> txt1, List<String> txt2,List<String> vid ) {
    ...
    @Override
    public Adapterrecmovieone.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.cardformovierecone, parent, false);
        return new Adapterrecmovieone.MyViewHolder(itemView);

    }


    @Override
    public void onBindViewHolder(Adapterrecmovieone.MyViewHolder holder, final int position) {
