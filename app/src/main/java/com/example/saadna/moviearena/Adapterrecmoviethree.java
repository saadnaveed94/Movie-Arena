...
public class Adapterrecmoviethree extends RecyclerView.Adapter<Adapterrecmoviethree.MyViewHolder>{
...
private List<String> txt1,vid;
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            imageButton = (ImageButton)view.findViewById(R.id.imgmovierecthree);
            t1 = (TextView)view.findViewById(R.id.txtmovierecthree);


        }
    }
    public Adapterrecmoviethree(List<String> url , List <String> txt1,List<String> vid) {
    ...
    @Override
    public Adapterrecmoviethree.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.cardforrecmoviethree, parent, false);
        return new Adapterrecmoviethree.MyViewHolder(itemView);

    }


    @Override
    public void onBindViewHolder(Adapterrecmoviethree.MyViewHolder holder, final int position) {
