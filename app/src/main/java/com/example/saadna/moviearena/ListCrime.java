...
public class ListCrime extends AppCompatActivity {
protected ArrayList<String> arrurl,arrtxt1,arrtxt2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        refone = database.getReference().child("listcrime");
        ...
        refone.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                LinearLayoutManager a = new LinearLayoutManager(ListCrime.this,LinearLayoutManager.VERTICAL,false);
                recyclerView = (RecyclerView)findViewById(R.id.listcrime);
