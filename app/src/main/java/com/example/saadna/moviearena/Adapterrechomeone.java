...
public class Adapterrechomeone  extends RecyclerView.Adapter<Adapterrechomeone.MyViewHolder>{
 ...
 private List<String> url;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            imageButton = (ImageButton)view.findViewById(R.id.imghomeoneback);
            t1 = (TextView)view.findViewById(R.id.cardhomenewsone);
            t2= (TextView)view.findViewById(R.id.cardhomenewsonetwo);
        }
    }
    public Adapterrechomeone(List<String> url, List<String> txt1, List<String> txt2,List<String> vid) {
    ...
    @Override
    public Adapterrechomeone.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.cardforrecone, parent, false);
        return new Adapterrechomeone.MyViewHolder(itemView);

    }


    @Override
    public void onBindViewHolder(Adapterrechomeone.MyViewHolder holder,final int position) {
