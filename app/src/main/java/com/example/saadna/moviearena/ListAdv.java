...
public class ListAdv extends AppCompatActivity {
...
private     RecyclerView recyclerView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_adv);


        database = FirebaseDatabase.getInstance();
        refone = database.getReference().child("listadv");
        ...
        refone.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
               ...
               Adapterreclistaction adapterreclistaction;
                LinearLayoutManager a = new LinearLayoutManager(ListAdv.this,LinearLayoutManager.VERTICAL,false);
                recyclerView = (RecyclerView)findViewById(R.id.listadv);
