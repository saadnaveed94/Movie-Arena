...
public class ListScitv extends AppCompatActivity {
protected ArrayList<String> arrurl,arrtxt1,arrtxt2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_scifitv);


        database = FirebaseDatabase.getInstance();
        refone = database.getReference().child("Listscifitv");
        ...
        refone.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                LinearLayoutManager a = new LinearLayoutManager(ListScitv.this,LinearLayoutManager.VERTICAL,false);
                recyclerView = (RecyclerView)findViewById(R.id.listscifitv);
