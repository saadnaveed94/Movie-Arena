...
public class Adapterrecmovietwo extends RecyclerView.Adapter<Adapterrecmovietwo.MyViewHolder>{
...
private List<String> txt1,vid;
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            imageButton = (ImageButton)view.findViewById(R.id.imgmovierectwo);
            t1 = (TextView)view.findViewById(R.id.txtmovierectwo);


        }
    }
    public Adapterrecmovietwo(List<String> url , List <String> txt1,List<String> vid ) {
...
this.vid= vid;
    ...
    @Override
    public Adapterrecmovietwo.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.cardforrecmovietwo, parent, false);
        return new Adapterrecmovietwo.MyViewHolder(itemView);

    }


    @Override
    public void onBindViewHolder(Adapterrecmovietwo.MyViewHolder holder, final int position) {
