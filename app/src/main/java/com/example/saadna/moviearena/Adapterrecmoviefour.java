...
public class Adapterrecmoviefour extends RecyclerView.Adapter<Adapterrecmoviefour.MyViewHolder>{
...
private List<String> txt1,vid;
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            imageButton = (ImageButton)view.findViewById(R.id.imgmovierecfour);
            t1 = (TextView)view.findViewById(R.id.txtmovierecfour);


        }
    }
    public Adapterrecmoviefour(List<String> url , List <String> txt1,List<String> vid ) {
...
this.vid= vid;
    ...
    @Override
    public Adapterrecmoviefour.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.cardforrecmoviefour, parent, false);
        return new Adapterrecmoviefour.MyViewHolder(itemView);

    }


    @Override
    public void onBindViewHolder(Adapterrecmoviefour.MyViewHolder holder, final int position) {
