...
public class ListFamilytv extends AppCompatActivity {
protected ArrayList<String> arrurl,arrtxt1,arrtxt2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_familytv);


        database = FirebaseDatabase.getInstance();
        refone = database.getReference().child("listfamilytv");
        ...
        refone.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                LinearLayoutManager a = new LinearLayoutManager(ListFamilytv.this,LinearLayoutManager.VERTICAL,false);
                recyclerView = (RecyclerView)findViewById(R.id.listfamilytv);
