...
public class Listwartv extends AppCompatActivity {
protected ArrayList<String> arrurl,arrtxt1,arrtxt2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_wartv);


        database = FirebaseDatabase.getInstance();
        refone = database.getReference().child("listwartv");
        ...
        refone.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                LinearLayoutManager a = new LinearLayoutManager(Listwartv.this,LinearLayoutManager.VERTICAL,false);
                recyclerView = (RecyclerView)findViewById(R.id.listwartv);
