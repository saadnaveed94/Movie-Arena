...
public class ListCrimetv extends AppCompatActivity {
protected ArrayList<String> arrurl,arrtxt1,arrtxt2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_crimetv);


        database = FirebaseDatabase.getInstance();
        refone = database.getReference().child("listcrimetv");
        ...
        refone.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                LinearLayoutManager a = new LinearLayoutManager(ListCrimetv.this,LinearLayoutManager.VERTICAL,false);
                recyclerView = (RecyclerView)findViewById(R.id.listcrimetv);
